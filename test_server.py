...
cmd_END_DAY = "CLOSING"
menu_file = "C:/Users/Shafeeq Amirudeen/Documents/Poly 1.2/ACG/Assignment 2 Baseline v5.0 (1)/Assignment 3 Baseline v5.0/Assignment3v5/client/day_end.csv"
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as my_socket:
    ...
    while file_bytes != b'':
        ...
        my_socket.sendall(encrypted_file_bytes)
        print(encrypted_file_bytes)
        # my_socket.sendall(key)
        # print("is my key ?", key)
